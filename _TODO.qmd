...
- [ ] _Potenzialità_: xxxx (es. indagini su uso dell'IA per fascia d'età; esperienze nelle scuole del territorio; letteratura su effetti sull'apprendimento)
- [ ] _Rischi_: xxxx (es. tempo/modalità d'uso e benessere; percezioni di famiglie e docenti; divari per condizione socio-economica)
- [ ] _Governare il processo_: xxxx (es. mappa delle realtà educanti e iniziative sull'IA a Parma; formazione docenti/educatori; linee guida da altri territori/paesi)

**Moduli/output previsti**: 

- [ ] da definire (se serve un modulo dati, o solo testo + fonti in pagina)
