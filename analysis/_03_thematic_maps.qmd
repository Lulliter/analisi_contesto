...
3. ~~`get_istatdata()`: scarica un dataset specifico~~ (non funziona perchè non filtrabile)
...
# Installazione pacchetto istatdata (se non già installato)
...
# --- get data (e.g. Popolazione residente per singole età, sesso e cittadinanza - comuni)
...
Posso usare invece il pacchetto `rsdmx` che consente più specifiche. 
...
```{r}
#istat_pop_com_PR_2023 <- readRDS("~/Github_CRP/analisi_contesto/data/data_out/istat_pop_com_PR_2023.rds")
